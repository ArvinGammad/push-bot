...
<header class="app-header">
	<nav class="navbar navbar-expand-lg navbar-light">
		<ul class="navbar-nav w-100">
			...
			<li class="nav-item">
				<a href="/dashboard" class="btn  me-2 w-100"><i class="ti ti-arrow-back-up"></i> Exit Editor</a>
			</li>
			<li class="nav-item ms-2">
				<a href="javascript:void(0)" class="btn btn-success btn-image-search">Image Search</a>
			</li>
			<li class="nav-item ms-2">
				<a href="javascript:void(0)" class="btn btn-primary btn-image-search">Image Generator</a>
			</li>
		</ul>
